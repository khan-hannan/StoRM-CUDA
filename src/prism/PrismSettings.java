...
public class PrismSettings implements Observer
{
	...
	/*** GPU PRISM code begin ***/
	public static final String PRISM_GPU							= "prism.gpu";
	/*** GPU PRISM code end ***/	
	...
	public static final Object[][][] propertyData =
	{
		{	//Datatype:			Key:									Display name:							Version:		Default:																	Constraints:																				Comment:
			...
			{ BOOLEAN_TYPE,		PRISM_GPU,								"Use of CUDA for GPUs",					"beta",			new Boolean(false),																	"",
																			"Speed up sparse matrix/vector multiplication by using NVIDIA GPUs" },
	...
	public synchronized int setFromCommandLineSwitch(String args[], int i) throws PrismException
	{
		...
		/*** GPU PRISM code start ***/
		else if (sw.equals("gpu_sparse") || sw.equals("gpu")) {
			set(PRISM_ENGINE, "Sparse");
			set(PRISM_GPU, true);
		}
		/*** GPU PRISM code end ***/
	...
	public void printHelp(PrismLog mainLog)
	{
		...
		/*** GPU PRISM code start ***/
		mainLog.println("-gpu_sparse (or -gpu)........... Use the CUDA Sparse engine");		
		/*** GPU PRISM code start ***/
