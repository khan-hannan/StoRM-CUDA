...
extern "C" int  mv (int n, void * b,bool compact_a, bool compact_b , bool compact_d,
	 						double *soln, int dist_mask, int dist_shift, jdouble omega,
							int max_iters, int term_crit, double term_crit_param, bool power);
extern "C" void  datacpy (int n, void * b,bool compact_a, bool compact_b , bool compact_d, double * b_vec, DistVector * b_dist,
...
extern "C" void  datafree(bool compact_a, bool compact_b, bool compact_d);
...
)
{
	...
	if (use_gpu) {
		...
		datacpy(n,(void * )b,compact_a,compact_b,compact_d, b_vec, b_dist, row_starts,non_zeros,soln,cols,
									dist,dist_mask,dist_shift,diags_vec,diags_dist);
		// matrix multiply
		iters = mv(n,(void * )b,compact_a,compact_b,compact_d,soln,dist_mask,dist_shift, omega, max_iters, term_crit, term_crit_param, false);
		done = (iters > 0 && iters < max_iters);
		
		datafree(compact_a, compact_b, compact_d);
